...
export class InitialMigration1681923069819 implements MigrationInterface {
    name = 'InitialMigration1681923069819'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "advertisements" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "brand" character varying(50) NOT NULL, "model" character varying(50) NOT NULL, "year" character varying(50) NOT NULL, "fuel" character varying(20) NOT NULL, "color" character varying(20) NOT NULL, "description" character varying(500) NOT NULL, "km" integer NOT NULL, "FIPE_price" numeric NOT NULL, "price" numeric NOT NULL, "cover_img" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP, "userId" uuid, CONSTRAINT "PK_4818a08332624787e5b2bf82302" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "users_advertisements" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP, "userId" uuid, "advertisementsId" uuid, CONSTRAINT "PK_36393d1159268f98ca154f59d97" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "users" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "email" character varying NOT NULL, "password" character varying NOT NULL, "cpf" character varying NOT NULL, "phone" character varying NOT NULL, "birthDate" character varying NOT NULL, "description" character varying(500) NOT NULL, "is_adm" boolean NOT NULL, "is_active" boolean NOT NULL DEFAULT true, "is_seller" boolean NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "addressId" uuid, CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email"), CONSTRAINT "UQ_230b925048540454c8b4c481e1c" UNIQUE ("cpf"), CONSTRAINT "REL_bafb08f60d7857f4670c172a6e" UNIQUE ("addressId"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "users_advertisements" ADD CONSTRAINT "FK_0ffcb03c79a0803207c1b5aca3f" FOREIGN KEY ("advertisementsId") REFERENCES "advertisements"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "users_advertisements" DROP CONSTRAINT "FK_0ffcb03c79a0803207c1b5aca3f"`);
